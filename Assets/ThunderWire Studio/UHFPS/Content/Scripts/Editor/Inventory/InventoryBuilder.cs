        ...
        private void OnDrawItemInspector(Rect inspectorView, ItemProperty property)
        {
            GUILayout.BeginArea(inspectorView);
            {
                ...
                EditorGUI.BeginChangeCheck();
                {
                    ...
                    property.description.stringValue = EditorGUI.TextArea(descriptionRect, property.description.stringValue);
                    ...
                    if (isUsable && EditorDrawing.BeginFoldoutBorderLayout(property.usableSettings, new GUIContent("Usable Settings")))
                    {
                        ...
                        {
                            SerializedProperty removeOnUse = property.usableSettings.FindPropertyRelative("removeOnUse");
                            SerializedProperty customData = property.usableSettings.FindPropertyRelative("customData");
